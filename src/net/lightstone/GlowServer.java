...
import net.lightstone.command.*;
import net.lightstone.io.StorageQueue;
import net.lightstone.io.mcregion.McRegionWorldStorageProvider;
import net.lightstone.net.MinecraftPipelineFactory;
import net.lightstone.net.Session;
import net.lightstone.net.SessionRegistry;
import net.lightstone.scheduler.GlowScheduler;
import net.lightstone.util.PlayerListFile;
import net.lightstone.util.bans.BanManager;
import net.lightstone.util.bans.FlatFileBanManager;
import net.lightstone.inventory.CraftingManager;
import net.lightstone.map.GlowMapView;
...
public final class GlowServer implements Server {
    ...
    private ChunkGenerator getGenerator(String name, Environment environment) {
        ...
        if (environment == Environment.NETHER) {
            return new net.lightstone.generator.UndergroundGenerator();
        } else if (environment == Environment.THE_END) {
            return new net.lightstone.generator.CakeTownGenerator();
        } else {
            return new net.lightstone.generator.SurfaceGenerator();
        }
    }
    ...
    public String getMotd() {
        return config.getString("server.motd", "Test lightstone server");
    }
