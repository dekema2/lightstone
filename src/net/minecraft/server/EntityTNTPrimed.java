...
public class EntityTNTPrimed extends Entity {
    ...
    public float yield = 4; // lightstone
    public boolean isIncendiary = false; // lightstone
    ...
    public void w_() {
        ...
        if (this.fuseTicks-- <= 0) {
            if (!this.world.isStatic) {
                // lightstone start - Need to reverse the order of the explosion and the entity death so we have a location for the event.
                this.explode();
                this.die();
                // lightstone end
            } else {
