...
import org.unxoft.lightstone.entity.CraftItem;
...
public abstract class EntityHuman extends EntityLiving {
    ...
    public int sleepTicks; // lightstone private -> public
    public float G;
    public float H;
    ...
    public void d() {
        ...
        if (this.world.difficulty == 0 && this.getHealth() < this.getMaxHealth() && this.ticksLived % 20 * 12 == 0) {
            // lightstone - added regain reason of "REGEN" for filtering purposes.
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        if (this.b != null) {
            ...
            nbttagcompound.setString("SpawnWorld", spawnWorld); // lightstone - fixes bed spawns for multiworld worlds
        }
            ...
            if (this.getHealth() <= 0) {
                ...
                if (i == 0) {
                    ...
                    if (entity1 instanceof EntityLiving) {
                        // lightstone start - this is here instead of EntityMonster because EntityLiving(s) that aren't monsters
    ...
    public void e(Entity entity) {
        if (!entity.b(this)) {
            ...
            if (itemstack != null && entity instanceof EntityLiving) {
                ...
                // lightstone - bypass infinite items; <= 0 -> == 0
                if (itemstack.count == 0) {
                    itemstack.a(this);
                    this.Q();
                }
    ...
    public void f(Entity entity) {
        ...
        if (i > 0 || k > 0) {
            ...
            // lightstone start - Don't call the event when the entity is human since it will be called with damageEntity
            ...
            // lightstone start - Return when the damage fails so that the item will not lose durability
            if (!flag1) {
                return;
            }
            // lightstone end
            ...
            if (entity instanceof EntityLiving) {
                ...
                if (l > 0) {
                    // lightstone start - raise a combust event when somebody hits with a fire enchanted item
    ...
    public void a(boolean flag, boolean flag1, boolean flag2) {
        if (this.fauxSleeping && !this.sleeping) return; // lightstone - Can't leave bed if not in one!
    ...
    public void a(ChunkCoordinates chunkcoordinates) {
        if (chunkcoordinates != null) {
            ...
            this.spawnWorld = this.world.worldData.name; // lightstone
        } else {
            this.b = null;
        }
    }
