...
public class EntityTracker {
    ...
    private int d;
    private World e; // lightstone - change type

    public EntityTracker(MinecraftServer minecraftserver, World i) { // lightstone - change method signature
        this.c = minecraftserver;
        this.e = i;
        this.d = minecraftserver.serverConfigurationManager.a();
    }

    // lightstone - synchronized
    ...
    public synchronized void addEntity(Entity entity, int i, int j, boolean flag) {
        ...
        if (this.trackedEntities.b(entity.id)) {
            // lightstone - removed exception throw as tracking an already tracked entity theoretically shouldn't cause any issues.
            ...
            entitytrackerentry.scanPlayers(this.e.players); // lightstone
        }
    }
    ...
    public synchronized void updatePlayers() {
        ...
        while (iterator.hasNext()) {
            ...
            entitytrackerentry.track(this.e.players); // lightstone
