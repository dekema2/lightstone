...
import org.unxoft.lightstone.util.LongBaseHashtable;
import org.unxoft.lightstone.util.EntryBase;
import org.unxoft.lightstone.util.LongHash;
import org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason;

public final class SpawnerCreature {

    // private static HashMap b = new HashMap(); // lightstone -- moved local to spawnEntities
    ...
    public static final int spawnEntities(World world, boolean flag, boolean flag1) {
        if (!flag && !flag1) {
            ...
            // b.clear(); // lightstone
            LongBaseHashtable chunkCoords = new LongBaseHashtable(); // lightstone
            ...
            ArrayList<EntryBase> b = chunkCoords.entries(); // lightstone
                                                ...
                                                if (a(enumcreaturetype, world, l2, i3, j3)) {
                                                    ...
                                                    if (world.findNearbyPlayer((double) f, (double) f1, (double) f2, 24.0D) == null) {
                                                        ...
                                                        if (f6 >= 576.0F) {
                                                            ...
                                                            if (entityliving.g()) {
                                                                ++j2;
                                                                // lightstone - added a reason for spawning this creature
