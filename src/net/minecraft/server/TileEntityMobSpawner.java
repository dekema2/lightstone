...
import org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason; // lightstone

public class TileEntityMobSpawner extends TileEntity {

    public int spawnDelay = -1;
    public String mobName = "Pig"; // lightstone - private -> public
    public double b;
    ...
    public void l_() {
        ...
        if (this.c()) {
            ...
            if (!this.world.isStatic) {
                ...
                for (int i = 0; i < b0; ++i) {
                    // lightstone start - bad entity detection
