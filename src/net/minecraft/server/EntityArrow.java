    ...
    public void a_(EntityHuman entityhuman) {
        if (!this.world.isStatic) {
            ...
            if (this.inGround && this.fromPlayer && this.shake <= 0 && entityhuman.inventory.canHold(itemstack) > 0) {
                ...
                PlayerPickupItemEvent event = new PlayerPickupItemEvent((org.bukkit.entity.Player) entityhuman.getBukkitEntity(), new org.unxoft.lightstone.entity.CraftItem(this.world.getServer(), item), 0);
