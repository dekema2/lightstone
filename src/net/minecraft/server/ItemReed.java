    ...
    public boolean a(ItemStack itemstack, EntityHuman entityhuman, World world, int i, int j, int k, int l) {
        ...
        if (!entityhuman.d(i, j, k)) {
            ...
            if (world.a(this.id, i, j, k, false, l)) {
                ...
                // lightstone start - This executes the placement of the block
                CraftBlockState replacedBlockState = CraftBlockState.getBlockState(world, i, j, k); // lightstone
                /**
                ...
                if (world.setRawTypeId(i, j, k, this.id)) { // <-- world.e does this to place the block
                    ...
                    if (event.isCancelled() || !event.canBuild()) {
                        // lightstone - undo; this only has reed, repeater and pie blocks
