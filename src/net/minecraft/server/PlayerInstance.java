...
class PlayerInstance {
    ...
    public void b(EntityPlayer entityplayer) {
        if (this.b.contains(entityplayer)) {
            ...
            // lightstone - contains -> remove -- TODO VERIFY!!!!
            ...
            if (this.dirtyCount == 1) {
                ...
                if (this.dirtyCount == 10) {
                    ...
                    for (i = 0; i < this.dirtyCount; ++i) {
                        // lightstone start - Fixes TileEntity updates occurring upon a multi-block change; dirtyCount -> dirtyBlocks[i]
                        ...
                        if (Block.isTileEntity[worldserver.getTypeId(j, k, l)]) {
                            // System.out.println("Sending!"); // lightstone
