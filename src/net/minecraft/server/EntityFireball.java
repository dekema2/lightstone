...
import org.unxoft.lightstone.entity.CraftLivingEntity;
...
public class EntityFireball extends Entity {
    ...
    public float yield = 1; // lightstone
    public boolean isIncendiary = true; // lightstone
    ...
    public EntityFireball(World world, EntityLiving entityliving, double d0, double d1, double d2) {
        ...
        // lightstone start (added setDirection method)
    ...
    protected void a(MovingObjectPosition movingobjectposition) {
        if (!this.world.isStatic) {
            ...
            // this.world.createExplosion((Entity) null, this.locX, this.locY, this.locZ, 1.0F, true); // lightstone
            this.die();
        }
    }
