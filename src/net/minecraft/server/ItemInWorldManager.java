...
public class ItemInWorldManager {
    ...
    // lightstone start - keep this for backwards compatibility
    ...
    public void c() {
        this.currentTick = (int) (System.currentTimeMillis() / 50); // lightstone
        if (this.j) {
    ...
    public void dig(int i, int j, int k, int l) {
        // this.world.douseFire((EntityHuman) null, i, j, k, l); // lightstone - moved down
        // lightstone start
        ...
        if (this.b()) {
            ...
            this.lastDigTick = (int) (System.currentTimeMillis() / 50); // lightstone
    ...
    public void a(int i, int j, int k) {
        ...
        // lightstone start - force blockreset to client
        } else {
            ((EntityPlayer) this.player).netServerHandler.sendPacket(new Packet53BlockChange(i, j, k, this.world));
            // lightstone end
        }
