...
public class EntityTrackerEntry {
    ...
    public void track(List list) {
        ...
        if (this.tracker.velocityChanged) {
            // lightstone start - create PlayerVelocity event
    ...
    private Packet b() {
        if (this.tracker.dead) {
            System.out.println("Fetching addPacket for removed entity: " + this.tracker.getBukkitEntity().toString()); // lightstone - add some information
        }
        ...
        if (this.tracker instanceof EntityItem) {
            ...
            // lightstone start - limit name length to 16 characters
