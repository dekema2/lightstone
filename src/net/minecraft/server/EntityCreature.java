...
public abstract class EntityCreature extends EntityLiving {
    ...
    public PathEntity pathEntity; // lightstone - public
    public Entity target; // lightstone - public
    ...
    protected void m_() {
        ...
        if (this.pathEntity != null && this.random.nextInt(100) != 0) {
            // MethodProfiler.a("followpath"); // lightstone -- not in production code
    ...
    protected void C() {
        // MethodProfiler.a("stroll"); // lightstone -- not in production code
        boolean flag = false;
        int i = -1;
        int j = -1;
        int k = -1;
