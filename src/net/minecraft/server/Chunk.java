...
import org.bukkit.Bukkit; // lightstone
...
public class Chunk {
    ...
    public Chunk(World world, int i, int j) {
        ...
        if (!(this instanceof EmptyChunk)) {
            org.unxoft.lightstone.CraftWorld cworld = this.world.getWorld();
            this.bukkitChunk = (cworld == null) ? null : cworld.popPreservedChunk(i, j);
            if (this.bukkitChunk == null) {
                this.bukkitChunk = new org.unxoft.lightstone.CraftChunk(this);
            }
        }
    }
            ...
            if (l != 0) {
                ...
                if (Block.byId[l] instanceof BlockContainer) {
                    ...
                    if (tileentity == null) {
                        ...
                        this.world.setTileEntity(i2, j, j2, tileentity); // lightstone - Use world rather than in-chunk coords
                    }
        ...
        if (k1 == l) {
            ...
            if (l != 0) {
                ...
                if (l > 0 && Block.byId[l] instanceof BlockContainer) {
                    ...
                    if (tileentity == null) {
                        tileentity = ((BlockContainer) Block.byId[l]).a_();
                        this.world.setTileEntity(l1, j, i2, tileentity); // lightstone - Use world rather than in-chunk coords
                    }
