...
public class EntityFallingBlock extends Entity {
        ...
        if (this.a == 0) {
            ...
            if (this.onGround) {
                ...
                if (this.world.getTypeId(i, j, k) != Block.PISTON_MOVING.id) {
                    this.die();
                    // lightstone -- setTypeId => setTypeIdAndData
    ...
    protected void b(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.setByte("Data", (byte) this.data); // lightstone
    }

    protected void a(NBTTagCompound nbttagcompound) {
        this.a = nbttagcompound.getByte("Tile") & 255;
        this.data = nbttagcompound.getByte("Data") & 15; // lightstone
    }
}
