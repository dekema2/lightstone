...
public class Block {
    ...
    public void dropNaturally(World world, int i, int j, int k, int l, float f, int i1) {
        if (!world.isStatic) {
            ...
            for (int k1 = 0; k1 < j1; ++k1) {
                // lightstone - <= to < to allow for plugins to completely disable block drops from explosions
    ...
    static {
        ...
        Item.byId[BIG_MUSHROOM_1.id] = new ItemWithAuxData(BIG_MUSHROOM_1.id - 256, BIG_MUSHROOM_1); // lightstone
        Item.byId[BIG_MUSHROOM_2.id] = new ItemWithAuxData(BIG_MUSHROOM_2.id - 256, BIG_MUSHROOM_2); // lightstone
