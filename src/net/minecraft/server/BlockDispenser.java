            ...
            for (int l = 0; l < tileentitydispenser.getSize(); ++l) {
                ...
                if (itemstack != null) {
                    ...
                    while (itemstack.count > 0) {
                        ...
                        itemstack.count -= i1;
                        EntityItem entityitem = new EntityItem(world, (double) ((float) i + f), (double) ((float) j + f1), (double) ((float) k + f2), new ItemStack(itemstack.id, i1, itemstack.getData(), itemstack.getEnchantments())); // lightstone - make sure enchantments are copied over
                        float f3 = 0.05F;
