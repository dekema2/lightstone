...
public final class ItemStack {
    ...
    public ItemStack(int i, int j, int k) {
        ...
        this.id = i;
        this.count = j;
        this.setData(k); // lightstone
    }

    // lightstone - used to create a new ItemStack, specifying the enchantments at time of creation.
    ...
    public void setData(int i) {
        this.damage = (this.id > 0) && (this.id < 256) ? Item.byId[this.id].filterData(i) : i; // lightstone
    }
