...
public class TileEntityChest extends TileEntity implements IInventory {
    ...
    private ItemStack[] items = new ItemStack[27]; // lightstone
    ...
    public boolean a(EntityHuman entityhuman) {
        if (this.world == null) return true; // lightstone
    ...
    private TileEntityChest getTileEntity(int x, int y, int z) {
        if (this.world == null) return null; // lightstone
    ...
    public void l_() {
        super.l_();
        if (this.world == null) return; // lightstone
        this.h();
        if (++this.j % (20 * 4) == 0) { // lightstone
