...
public class Packet51MapChunk extends Packet {
    ...
    public int f;
    public byte[] g;
    public int h; // lightstone - private -> public
    public byte[] rawData; // lightstone
    ...
    public Packet51MapChunk(int i, int j, int k, int l, int i1, int j1, byte[] data) {
        ...
        this.e = i1;
        this.f = j1;
        /* lightstone - Moved compression into its own method.
        byte[] abyte = data; // lightstone - uses data from above constructor
        ...
        this.rawData = data; // lightstone
    }

    public void a(DataInputStream datainputstream) throws IOException { // lightstone - throws IOEXception
    ...
    public void a(DataOutputStream dataoutputstream) throws IOException { // lightstone - throws IOException
