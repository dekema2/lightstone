...
import org.bukkit.BlockChangeDelegate; // lightstone
...
public class WorldGenTaiga1 extends WorldGenerator {
    ...
    public boolean generate(BlockChangeDelegate world, Random random, int i, int j, int k) {
        ...
        if (j >= 1 && j + l + 1 <= world.getHeight()) { // lightstone
            int l1;
            int i2;
            int j2;
            int k2;
            ...
            for (l1 = j; l1 <= j + 1 + l && flag; ++l1) {
                ...
                for (i2 = i - l2; i2 <= i + l2 && flag; ++i2) {
                    for (j2 = k - l2; j2 <= k + l2 && flag; ++j2) {
                        if (l1 >= 0 && l1 < world.getHeight()) { // lightstone
            ...
            if (!flag) {
                ...
                if ((l1 == Block.GRASS.id || l1 == Block.DIRT.id) && j < world.getHeight() - l - 1) { // lightstone
