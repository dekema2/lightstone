...
public abstract class Entity {
    ...
    public float bF;
    public float bG;
    public float fallDistance; // lightstone - private -> public
    private int b;
    public double bI;
    public double bJ;
    public double bK;
    ...
    public int fireTicks; // lightstone - private -> public
    ...
    public boolean ca;
    public boolean cb;
    public UUID uniqueId = UUID.randomUUID(); // lightstone
    ...
    protected void c(float f, float f1) {
        // lightstone start - yaw was sometimes set to NaN, so we need to set it back to 0.
        if (Float.isNaN(f)) {
            f = 0;
        }
    ...
    public void af() {
        // MethodProfiler.a("entityBaseTick"); // lightstone -- not in production code
        ...
        if (this.world.isStatic) {
            ...
            if (this.fireProof) {
                ...
                if (this.fireTicks % 20 == 0) {
                    // lightstone start - TODO: this event spams!
    ...
    protected void av() {
        if (!this.fireProof) {
            // lightstone start - fallen in lava TODO: this event spams!
            if (this instanceof EntityLiving) {
            ...
            // lightstone end - we also don't throw an event unless the object in lava is living, to save on some event calls
    ...
    public void move(double d0, double d1, double d2) {
        if (this.bN) {
            ...
            // MethodProfiler.a("move"); // lightstone -- not in production code
            this.bL *= 0.4F;
            double d3 = this.locX;
            double d4 = this.locZ;
            ...
            // MethodProfiler.a(); // lightstone -- not in production code
            // MethodProfiler.a("rest"); // lightstone -- not in production code
            this.locX = (this.boundingBox.a + this.boundingBox.d) / 2.0D;
            this.locY = this.boundingBox.b + (double) this.height - (double) this.bL;
            this.locZ = (this.boundingBox.c + this.boundingBox.f) / 2.0D;
            ...
            if (this.world.d(this.boundingBox.shrink(0.0010D, 0.0010D, 0.0010D))) {
                ...
                if (!flag2) {
                    ++this.fireTicks;
                    // lightstone start - not on fire yet
    ...
    public void spawnIn(World world) {
        ...
        if (world == null) {
            this.die();
            this.world = ((org.unxoft.lightstone.CraftWorld) Bukkit.getServer().getWorlds().get(0)).getHandle();
            return;
        }
        // lightstone end
        this.world = world;
    ...
    public void d(NBTTagCompound nbttagcompound) {
        ...
        // lightstone start - checking for NaN pitch/yaw and resetting to zero
    ...
    public void e(NBTTagCompound nbttagcompound) {
        ...
        /* lightstone start - moved section down
        ...
        // lightstone start - Exempt Vehicles from notch's sanity check
        ...
        if (this instanceof EntityPlayer) {
            ...
            if (bworld == null) {
                ...
                bworld = ((org.unxoft.lightstone.CraftServer) server).getServer().getWorldServer(entityPlayer.dimension).getWorld();
            }

            this.spawnIn(bworld == null ? null : ((org.unxoft.lightstone.CraftWorld) bworld).getHandle());
        }
        // lightstone end
    }
    ...
    public org.bukkit.entity.Entity getBukkitEntity() {
        if (this.bukkitEntity == null) {
            this.bukkitEntity = org.unxoft.lightstone.entity.CraftEntity.getEntity(this.world.getServer(), this);
        }
    ...
    public void a(EntityWeatherLighting entityweatherlighting) {
        ...
        ++this.fireTicks;
        if (this.fireTicks == 0) {
            // lightstone start - raise a combust event when lightning strikes
