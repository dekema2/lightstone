...
import org.unxoft.lightstone.generator.CustomChunkGenerator;
import org.unxoft.lightstone.generator.InternalChunkGenerator;
import org.unxoft.lightstone.generator.NetherChunkGenerator;
import org.unxoft.lightstone.generator.NormalChunkGenerator;
import org.unxoft.lightstone.generator.SkyLandsChunkGenerator;
...
public class WorldServer extends World implements BlockChangeDelegate {
    ...
    public final MinecraftServer server; // lightstone - private -> public final
    private IntHashMap N;

    // lightstone start - change signature
    ...
    public void entityJoinedWorld(Entity entity, boolean flag) {
        /* lightstone start - We prevent spawning in general, so this butchering is not needed
    ...
    public boolean a(EntityHuman entityhuman, int i, int j, int k) {
        ...
        // lightstone - Configurable spawn protection
    ...
    protected void i() {
        ...
        super.i();
        if (flag != this.w()) {
            // lightstone start - only sending weather packets to those affected
