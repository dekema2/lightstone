...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public int cf = -99999999; // lightstone - priv to pub - "lastSentExp"
    public int cg = 60; // lightstone - private to public; temporary until we get an API out
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        getPlayer().readExtraData(nbttagcompound); // lightstone
    }

    public void b(NBTTagCompound nbttagcompound) {
        super.b(nbttagcompound);
        nbttagcompound.setInt("playerGameType", this.itemInWorldManager.a());
        getPlayer().setExtraData(nbttagcompound); // lightstone
    }

    public void spawnIn(World world) {
        super.spawnIn(world);
        // lightstone - world fallback code, either respawn location or global spawn
        if (world == null) {
            this.dead = false;
    ...
    public void die(DamageSource damagesource) {
        ...
        // lightstone - we clean the player's inventory after the EntityDeathEvent is called so plugins can get the exact state of the inventory.
        for (int i = 0; i < this.inventory.items.length; ++i) {
    ...
    public boolean damageEntity(DamageSource damagesource, int i) {
        if (this.cg > 0) {
            ...
            // lightstone - this.b.pvpMode -> this.world.pvpMode
    ...
    public void a(boolean flag) {
        ...
        if (flag && !this.chunkCoordIntPairQueue.isEmpty()) {
            ...
            if (chunkcoordintpair != null) {
                ...
                if (this.netServerHandler.b() + ChunkCompressionThread.getPlayerQueueSize(this) < 4) { // lightstone - Add check against Chunk Packets in the ChunkCompressionThread.
                    flag1 = true;
                }
        ...
        if (this.J) {
            //if (this.b.propertyManager.getBoolean("allow-nether", true)) { // lightstone
    ...
    public void e(int i) {
        if (this.dimension == 1 && i == 1) {
            ...
            /* //lightstone start - removed to fix our handling of The End portals
