...
public class ItemWorldMap extends ItemWorldMapBase {
    ...
    public WorldMap a(ItemStack itemstack, World world) {
        ...
        if (worldmap == null) {
            ...
            worldmap.scale = 3;
            worldmap.map = (byte) ((WorldServer) world).dimension; // lightstone - fixes Bukkit multiworld maps.
            worldmap.a();
    ...
    public void a(World world, Entity entity, WorldMap worldmap) {
        if (((WorldServer) world).dimension == worldmap.map) { // lightstone
            short short1 = 128;
            short short2 = 128;
                ...
                if ((k1 & 15) == (worldmap.g & 15)) {
                    ...
                    for (int j2 = i1 - j1 - 1; j2 < i1 + j1; ++j2) {
                        if (k1 >= 0 && j2 >= -1 && k1 < short1 && j2 < short2) {
                            ...
                            if (chunk.isEmpty()) continue; // lightstone - fixes maps erasing themselves on low chunk visibility.
                            int k3 = i3 & 15;
                            int l3 = j3 & 15;
                            int i4 = 0;
                            double d1 = 0.0D;
