...
public class NetworkManager {
    ...
    public Socket socket; // lightstone - private -> public
    ...
    public NetworkManager(Socket socket, String s, NetHandler nethandler) {
        ...
        // lightstone start - IPv6 stack in Java on BSD/OSX doesn't support setTrafficClass
        try {
        ...
        try {
            // lightstone start - cant compile these outside the try
    ...
    private boolean g() {
        ...
        try {
            ...
            // lightstone - don't allow low priority packet to be sent unless it was placed in the queue before the first packet on the high priority queue
