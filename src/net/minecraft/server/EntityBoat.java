...
public class EntityBoat extends Entity {
    ...
    public EntityBoat(World world, double d0, double d1, double d2) {
        ...
        this.world.getServer().getPluginManager().callEvent(new VehicleCreateEvent((Vehicle) this.getBukkitEntity())); // lightstone
    }
    ...
    public void w_() {
        ...
        if (this.world.isStatic) {
            ...
            if (this.passenger != null) {
                this.motX += this.passenger.motX * occupiedDeceleration; // lightstone
                this.motZ += this.passenger.motZ * occupiedDeceleration; // lightstone
            }
            // lightstone start - block not in vanilla
            ...
            if (this.onGround && !landBoats) { // lightstone
                this.motX *= 0.5D;
                this.motY *= 0.5D;
                this.motZ *= 0.5D;
            }
            ...
            if (this.passenger != null && this.passenger.dead) {
                this.passenger.vehicle = null; // lightstone
                this.passenger = null;
            }
        }
    }
