...
import org.bukkit.event.player.PlayerPickupItemEvent; // lightstone
...
public class EntityItem extends Entity {
    ...
    private int lastTick = (int) (System.currentTimeMillis() / 50); // lightstone
    ...
    public EntityItem(World world, double d0, double d1, double d2, ItemStack itemstack) {
        ...
        // lightstone start - infinite item fix
